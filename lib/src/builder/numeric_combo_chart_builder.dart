...
/// Creates a NumericComboChart widget based on the JSON structure.
class NumericComboChartBuilder extends JsonWidgetBuilder {
  NumericComboChartBuilder({
  ...
  static const type = 'numeric_combo_chart';
  ...
  final common.SeriesRendererConfig<num>? defaultRenderer;
  ...
  ///   "defaultRenderer": <common.SeriesRendererConfig<String>>,
  ...
  /// }
  /// ```
  static NumericComboChartBuilder fromDynamic(
    dynamic map, {
    JsonWidgetRegistry? registry,
  }) {
    if (map == null) {
      throw Exception('[NumericComboChartBuilder]: map is null');
    }

    return NumericComboChartBuilder(
      animate:
      ...
      defaultRenderer: JsonChartsDecoder.decodeSeriesRendererConfig<num>(
        map['defaultRenderer'],
        validate: false,
      ),
  ...
  Widget buildCustom({
    ...
    assert(
      ...
      '[NumericComboChartBuilder] does not support children.',
    );
