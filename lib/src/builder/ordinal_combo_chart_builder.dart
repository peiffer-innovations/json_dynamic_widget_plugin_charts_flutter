...
/// Creates a OrdinalComboChart widget based on the JSON structure.
class OrdinalComboChartBuilder extends JsonWidgetBuilder {
  OrdinalComboChartBuilder({
  ...
  static const type = 'ordinal_combo_chart';
  ...
  Widget buildCustom({
    ...
    assert(
      ...
      '[OrdinalComboChartBuilder] does not support children.',
    );
